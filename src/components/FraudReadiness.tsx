          ...
          <div className="border border-gray-200 rounded">
            ...
            {advancedOpen && (
              <div className="p-4 grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-gray-200">
                ...
                <label className="block">
                  <span className="text-sm font-medium text-gray-600">card_decline_count_24h</span>
                  <input
                    type="number"
                    min={0}
                    value={payload.card_decline_count_24h ?? ''}
                    onChange={(e) =>
                      update('card_decline_count_24h', e.target.value === '' ? undefined : Number(e.target.value))
                    }
                    className="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-gray-900"
                  />
                </label>
                <label className="block">
                  <span className="text-sm font-medium text-gray-600">failed_login_count_24h</span>
                  <input
                    type="number"
                    min={0}
                    value={payload.failed_login_count_24h ?? ''}
                    onChange={(e) =>
                      update('failed_login_count_24h', e.target.value === '' ? undefined : Number(e.target.value))
                    }
                    className="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-gray-900"
                  />
                </label>
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={(e) => update('device_id', e.target.value || undefined)}
